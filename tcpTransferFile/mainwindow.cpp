...
void MainWindow::getRecState(int state)
{
    ...
    case receiveThread::recBegin:{
        ...
        //progressBar->setValue((double)receiveThread::fileRecSize/receiveThread::targetRecFileSize*100);
    }break;
...
void MainWindow::getTransState(int state)
{
    ...
    case sendThread::sendProcessing:{
        progressBar->setValue((double)sendthread->fileSendSize/sendthread->fileMaxSize*100);
    }break;
